module DragoonsHelper
  ...
  def website_contributions_count(dragoon)
    return news_entry_count(dragoon) + article_count(dragoon) +
      download_count(dragoon) + link_count(dragoon) +
      music_track_count(dragoon) + picture_count(dragoon) +
      poem_count(dragoon) + quiz_count(dragoon) + resource_count(dragoon) +
      story_count(dragoon) + video_count(dragoon)
  end
end
