...
ActiveRecord::Schema.define(version: 2021_12_01_070122) do
  ...
  create_table "categories", id: :serial, force: :cascade do |t|
    ...
    t.datetime "category_picture_updated_at", precision: 6
  ...
  create_table "downloads", id: :serial, force: :cascade do |t|
    ...
    t.datetime "download_updated_at", precision: 6
    t.boolean "publish", default: false
    t.integer "category_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
    ...
    t.datetime "download_picture_updated_at", precision: 6
    t.datetime "published_at", precision: 6
  end
  ...
  create_table "illustrations", id: :serial, force: :cascade do |t|
    ...
    t.datetime "illustration_updated_at", precision: 6
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
  end
  ...
  create_table "music_tracks", id: :serial, force: :cascade do |t|
    ...
    t.datetime "mp3_music_track_updated_at", precision: 6
    t.boolean "publish", default: false
    t.integer "category_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
  ...
  create_table "news_entries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "news_entry_picture_updated_at", precision: 6
    t.string "summary"
  end
  ...
  create_table "pages", id: :serial, force: :cascade do |t|
    ...
    t.datetime "page_picture_updated_at", precision: 6
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
    t.datetime "published_at", precision: 6
  ...
  create_table "tags", id: :serial, force: :cascade do |t|
    ...
    t.datetime "tag_picture_updated_at", precision: 6
    t.text "information"
    t.string "wiki_slug"
  end
  ...
  create_table "videos", id: :serial, force: :cascade do |t|
    ...
    t.datetime "mp4_video_updated_at", precision: 6
    t.boolean "publish", default: false
    t.integer "category_id"
    t.datetime "created_at", precision: 6
    t.datetime "updated_at", precision: 6
    ...
    t.datetime "video_picture_updated_at", precision: 6
    t.datetime "published_at", precision: 6
    t.string "source_url"
    t.integer "album_id"
    t.integer "sequence_number", default: 0
