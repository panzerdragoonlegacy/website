...
describe ResourcePolicy do
  ...
  context 'visitor creating a new resource' do
  ...
  context 'visitor accessing resources in a published category' do
  ...
  context 'visitor accessing resources in an unpublished category' do
    context 'accessing a published resource' do
      let(:resource) do
