...
describe SpecialPagePolicy do
  ...
  context 'visitor creating a new special page' do
  ...
  context 'visitor accessing a published special page' do
    let(:special_page) do
  ...
  context 'visitor accessing an unpublished special page' do
    let(:special_page) do
