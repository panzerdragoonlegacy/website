...
describe ArticlePolicy do
  ...
  context 'contributor creating a new article' do
  ...
  context 'contributor accessing articles in a published category' do
  ...
  context 'contributor accessing articles in an unpublished category' do
    context 'accessing articles that the user does not contribute to' do
      context 'accessing a published article' do
        let(:article) do
          FactoryGirl.create(:published_article_in_published_category)
