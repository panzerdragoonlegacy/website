...
describe ArticlePolicy do
  ...
  context 'registered user creating a new article' do
  ...
  context 'registered user accessing articles in a published category' do
  ...
  context 'registered user accessing articles in an unpublished category' do
    context 'accessing a published article' do
      let(:article) do
