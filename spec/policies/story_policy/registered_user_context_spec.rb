...
describe StoryPolicy do
  ...
  context 'registered user creating a new story' do
    let(:story) { Story.new }
  ...
  context 'registered user accessing stories in a published category' do
  ...
  context 'registered user accessing stories in an unpublished category' do
    context 'accessing a published story' do
      let(:story) do
