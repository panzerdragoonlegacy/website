...
describe StoryPolicy do
  ...
  context 'contributor creating a new story' do
    let(:story) { Story.new }
  ...
  context 'contributor accessing stories in a published category' do
  ...
  context 'contributor accessing stories in an unpublished category' do
    context 'accessing stories that the user does not contribute to' do
      context 'accessing a published story' do
        let(:story) do
          FactoryGirl.create(:published_story_in_published_category)
