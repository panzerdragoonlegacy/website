...
describe StoryPolicy do
  ...
  context 'visitor creating a new story' do
    let(:story) { Story.new }
  ...
  context 'visitor accessing stories in a published category' do
  ...
  context 'visitor accessing stories in an unpublished category' do
    context 'accessing a published story' do
      let(:story) do
