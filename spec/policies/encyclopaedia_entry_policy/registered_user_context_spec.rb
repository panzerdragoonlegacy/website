...
describe EncyclopaediaEntryPolicy do
  ...
  context 'registered user creating a new encyclopaedia entry' do
  ...
  context 'registered user accessing encyclopaedia entries in a published ' \
          'category' do
  ...
  context 'registered user accessing encyclopaedia entries in an unpublished ' \
          'category' do
    context 'accessing a published encyclopaedia entry' do
      let(:encyclopaedia_entry) do
        FactoryGirl.create(
