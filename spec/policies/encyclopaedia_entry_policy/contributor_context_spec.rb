...
describe EncyclopaediaEntryPolicy do
  ...
  context 'contributor creating a new encyclopaedia_entry' do
  ...
  context 'contributor accessing encyclopaedia entries in a published ' \
          'category' do
  ...
  context 'contributor accessing encyclopaedia entries in an unpublished ' \
          'category' do
    context 'accessing encyclopaedia entries that the user does not ' \
            'contribute to' do
      context 'accessing a published encyclopaedia entry' do
