...
describe PoemPolicy do
  ...
  context 'contributor creating a new poem' do
    let(:poem) { Poem.new }
  ...
  context 'contributor accessing poems that the user does not contribute to' do
  ...
  context 'contributor accessing poems the user contributes to' do
    context 'accessing a published poem' do
      let(:poem) do
        FactoryGirl.create(
          :published_poem,
