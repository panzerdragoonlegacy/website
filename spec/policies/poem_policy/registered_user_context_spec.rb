...
describe PoemPolicy do
  ...
  context 'registered user creating a new poem' do
    let(:poem) { Poem.new }
  ...
  context 'registered user accessing a published poem' do
  ...
  context 'registered user accessing an unpublished poem' do
